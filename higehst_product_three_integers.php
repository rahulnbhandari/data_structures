...
function findHighestProductFromThhreeIntegers($array) {
	$count = count($array);	
...
if(sort($array)) {
 ...
 print(findHighestProductFromThhreeIntegers($array1)."\n");
 print(findHighestProductFromThhreeIntegers($array2)."\n");
 print(findHighestProductFromThhreeIntegers($array3)."\n");
 print(findHighestProductFromThhreeIntegers($array4)."\n");
 print(findHighestProductFromThhreeIntegers($array5)."\n");
 print(findHighestProductFromThhreeIntegers($array6)."\n");
